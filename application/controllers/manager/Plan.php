...
class Plan extends CI_Controller 
{
	...
	{		
		...
		$this->load->view('manager/plan/index',$data);
	}
	public function add()
	{		
		$this->load->view('manager/plan/add');
	}
	...
	{		
		...
		redirect(base_url('manager/plan'));
	}
	...
	{	$this->db->where('Plan_ID',$id);
		$data['prices']=$this->db->get('subplans_pricing')->result();
		$this->load->view('manager/plan/edit',$data);
	}
	public function view($id)
	{
		$this->db->where('Plan_ID',$id);
		$data['users']=$this->db->get('subplans_pricing')->result();
		$this->load->view('manager/plan/view',$data);
	}
