      ...
      <div class="main_title margin_mobile">
      	...
      	<div class="row">
            <div class="col-md-4 col-md-offset-2">
                ...
                <img src="<?php echo base_url();?>img/submit_restaurant.jpg" width="848" height="480" alt="" class="img-responsive">
            ...
            <div class="col-md-4">
                ...
                <img src="<?php echo base_url();?>img/delivery.jpg" width="848" height="480" alt="" class="img-responsive">
...
<script type="text/javascript">
    function showHint(str) 
    {
        $.ajax({
            ...
            {
               document.getElementById('txtshow').innerHTML=res;
            }
        })
